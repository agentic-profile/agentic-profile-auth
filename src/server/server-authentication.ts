...
export async function handleAuthorization(
    ...
    ensure(tokens[0].toLowerCase() === AGENTIC_SCHEME.toLowerCase(), "Unsupported authorization type: ", tokens[0]);
    ensure(tokens.length >= 2, `Missing ${AGENTIC_SCHEME} authorization token`);
